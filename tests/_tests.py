...
class Test(object):
	...
	def getFunction(self, functionName):
		if not asserts.fileContainsFunctionDefinitions(self._fileName, functionName):
			raise exception.CheckpyError(f"Required function {functionName} is not defined")
